...
public class DimensionUtils {
    ...
    public static final ResourceKey<Level> THE_NETHER = ResourceKey.create(Registries.DIMENSION, Identifier.withDefaultNamespace("the_nether"));
    public static final ResourceKey<Level> THE_END = ResourceKey.create(Registries.DIMENSION, Identifier.withDefaultNamespace("the_end"));
    ...
    public static MutableComponent translateDimension(ResourceKey<Level> dimension) {
        String[] split = dimension.identifier().getPath().split("_");
